...
export default function ManagerWFH() {
  ...
  // Filtered company/team records according to active filters
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `manager_wfh_requests_${new Date().toISOString().slice(0, 10)}.csv`);
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight mt-1">
            Team & Company WFH Management
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Review remote work requests, manage approvals, and apply for your own WFH days.
          </p>
        </div>
      ...
      {/* 5. Apply WFH Modal (for Manager's own application) */}
      <ApplyWFHModal
